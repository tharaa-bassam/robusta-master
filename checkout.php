...
<form action="" method="post">
   ...
   <div class="cart-items">
      ...
      ?>
      <p><span class="name"><?= $fetch_cart['name']; ?></span><span class="price">JD<?= $fetch_cart['price']; ?> x <?= $fetch_cart['quantity']; ?></span></p>
      <?php
            }
         }else{
      ...
      ?>
      <p class="grand-total"><span class="name">grand total :</span><span class="price"><?= $grand_total; ?>JD</span></p>
